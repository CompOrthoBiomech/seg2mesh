...
.. raw:: html
    ...
    <figure style="text-align: center;">
        ...
        <figcaption style="font-style: italic;">
            Slice through animation of the unprocessed and processed labels overlaid on the MRI.
        </figcaption>
    </figure>
...
.. figure:: _static/overlay_contiguous_repair.png
    ...
    A slightly zoomed single slice comparison of the unprocessed and processed labels. Notice the
...
.. figure:: _static/acvd_mesh.png
    ...
    The triangular meshes generated by the pipeline for the specified configuration.
...
.. figure:: _static/acvd_error_metrics.png
    ...
    Error metrics are stored when saved in VTP format. Aggregate measures like Dice Coefficient (left)
